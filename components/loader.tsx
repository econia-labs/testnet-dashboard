...
const Loader = ({ animationFinished }: { animationFinished: boolean }) => {
    return (
        <div className={`fixed top-0 left-0 pointer-events-none w-full h-full bg-800 bg-noise grid place-items-center z-[1] transition-opacity duration-2000 ${animationFinished ? "opacity-0" : ""}`}>
