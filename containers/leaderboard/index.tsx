...
const LeaderBoardContainer = () => {
  return (
    <div className="flex flex-col items-center w-317 sm:w-437 md:w-605 lg:w-757 m-auto max-h-[calc(100vh-71.3px)]">
      <div className="mt-58">
        <CountDown />
      </div>
      ...
      <div className="mt-42 md:mt-52 lg:mt-36 grow overflow-y-scroll">
        <LeaderboardTable />
      </div>
